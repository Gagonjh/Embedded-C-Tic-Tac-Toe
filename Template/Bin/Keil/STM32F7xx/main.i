...
cHwTimer_N timerFast ( cHwTimer_N::TIM_4,  1000L  );
...
cDevDigital   &btnPlus  = btnLeft;  
cDevDigital   &btnMinus = btnRight; 
...
int main(void)
{
  ...
  disp.printf(0,0,0,"Jun  8 2021" " " "19:16:36");
